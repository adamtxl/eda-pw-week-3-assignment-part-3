...
console.log('The second supply change is:', supplyChanges[1]);
...
let boxCapacity = 7;
let boxes = 0;
let partsRemaining = parts;
while (partsRemaining > 0) {
    partsRemaining -= boxCapacity;
    boxes++;
    //console.log('Parts remaining after boxes' , boxes, ':', partsRemaining);
}
console.log('There are ', boxes, 'boxes and ', partsRemaining >= 0 ? partsRemaining : 0, 'parts remaining.');